...
export default function Team({ dict }: TeamProps) {
  ...
  return (
    ...
    >
      <div className="w-[512px] h-[512px] rounded-full blur-[200px] bg-[#C3C2FF] absolute right-[-256px] top-[-256px]"></div>
      <div className="w-[512px] h-[512px] rounded-full blur-[200px] bg-[#D2F9EA] absolute left-[-256px] bottom-[-256px]"></div>
      <div
        className={cn(
            ...
            >
              ...
              <div className="h-[260px] relative overflow-hidden">
                ...
                <figure className="absolute left-[11px] top-[17px] w-[173px] bottom-0">
                  <Image
                    src={memberImages[index] || '/images/team/placeholder.png'}
                    alt={member.name}
                    fill
